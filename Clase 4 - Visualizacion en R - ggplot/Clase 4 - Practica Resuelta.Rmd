...
1.  Levantar una o más bases internacionales del repositorio de precariedad mundial. Filtrar para conservar únicamente a la población asalariada. Calcular, para cada país, el promedio del ingreso en paridad de poder adquisitivo (Variable **ING_PPA**) y la tasa de precariedad considerando sólo una de las dimensiones presentes.
