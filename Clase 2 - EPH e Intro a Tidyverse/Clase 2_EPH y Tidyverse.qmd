...
En los Estudios del Trabajo se suele utilizar microdatos provenientes de encuestas de hogares. Estas encuestas son una herramienta para obtener información detallada sobre las características socioeconómicas, demográficas y laborales de las personas que forman parte de los hogares de un país o región. Las encuestas se realizan sobre una muestra de hogares representativa de la población general y suelen ser llevadas a cabo por organismos oficiales de estadística. Su publicación suele hacerse al nivel de personas (donde cada fila del dataframe representa una persona del hogar), aunque también puede haber una publicación complementaria a nivel de los hogares. Gran parte del trabajo con los microdatos se realiza junto a un **Diseño de Registro**, que funciona como un ‘diccionario’ sobre las variables del dataframe. En dicho documento se indican las preguntas y respuestas relacionadas a cada variable y los valores que éstas toman. En la carpeta *Fuentes*, pueden encontrar el diseño de registro actual de la EPH ("EPH_registro_1T2025.pdf") así como también otros documentos metodológicos de la encuesta.
...
Levantamos la base individual del cuarto trimestre de 2025, y un listado que contiene los Nombres y Códigos de los Aglomerados EPH.
...
Luego de abordar las principales funciones necesarias para operar sobre las bases de datos, trabajaremos a continuación con otras variables de la base del 4to Trimestre de 2025 de la EPH. El ejercicio principal consistirá en calcular la **tasa de empleo**, definida como:
