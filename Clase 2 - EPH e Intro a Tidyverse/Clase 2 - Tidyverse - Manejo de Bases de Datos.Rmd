...
subtitle: "Clase 2 - EPH e introducción a Tidyverse"
output:
  html_notebook:
    toc: yes
    toc_float: yes
...
Entre ellos usaremos principalmente **dplyr** y **tidyr** para realizar transformaciones sobre nuestro set de datos, y **ggplot** para realizar gráficos (este último se verá en la clase 4).

A continuación cargamos el paquete a nuestro ambiente. Para ello debe estar previamente instalada en nuestra pc. También utilizaremos los paquetes **openxlsx**, **eph** y **scales**
