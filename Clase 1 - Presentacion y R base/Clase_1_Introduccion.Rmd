...
Existen distintas modalidades de asistencia con IA ('Plan', 'Ask' y 'Agent'). La modalidad 'Plan' nos permite generar un plan de trabajo a partir de un prompt, la modalidad 'Ask' nos permite hacer preguntas sobre el código, y la modalidad 'Agent' nos permite interactuar con la IA a través de una ventana de chat.
