...
Este curso busca dar las herramientas básicas para el procesamiento de estadísticas socio-laborales con R y la visualización de resultados con PowerBI y Looker. Este es su cronogama:
...
Es una aplicación de escritorio que permite interactuar con GitHub de manera aún más amigable. Permite hacer los mismos pasos que con Git, pero de manera más visual. Es otra buena opción para aquellos que no quieren trabajar con la consola de comandos o quieren revisar los cambios hechos en el código.
