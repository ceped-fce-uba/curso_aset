...
Ejecutamos la función, específicando las columnas correspondientes (en este caso, la función está diseñada para recibir las columnas como strings) y el período más reciente (2023T4) como base elegida para
