...
En los Estudios del Trabajo se suele utilizar microdatos provenientes de encuestas de hogares. Estas encuestas son una herramienta para obtener información detallada sobre las características socioeconómicas, demográficas y laborales de las personas que forman parte de los hogares de un país o región. Las encuestas se realizan sobre una muestra de hogares representativa de la población general y suelen ser llevadas a cabo por organismos oficiales de estadística. Su publicación suele hacerse a nivel de personas (donde cada fila del dataframe representa una persona del hogar), aunque también puede haber una publicación complementaria a nivel de los hogares.
Gran parte del trabajo con los microdatos se realiza junto a un **Diseño de Registro**, que funciona como un ‘diccionario’ sobre las variables del dataframe. En ese documento se indican las preguntas y respuestas relacionadas a cada variable y los valores que éstas toman. Si bien las encuestas de hogares tienden a homogeneizarse entre sí, todavía persisten distintos criterios sobre temas como el área de cobertura, las preguntas que se realizan o los clasificadores utilizados, entre otros tantos aspectos. Por ello, para realizar comparaciones entre países debemos tomar decisiones para homogeneizar los datos en base a los diseños de registro.
...
> Consigna 2. Calcular la proporción de asalariados con al menos un signo de precariedad laboral utilizando el repositorio ```precariedad.mundial```
