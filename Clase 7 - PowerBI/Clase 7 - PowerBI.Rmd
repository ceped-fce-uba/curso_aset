...
Estas herramientas pueden ser utilizadas para presentar estadísticas económicas y socio-laborales de forma manera clara y comprensible. Para Argentina está el ejemplo de los tableros desarrollados en PowerBI por el [CEP XXI - Centro de Estudios para la Producción](https://www.argentina.gob.ar/produccion/cep/tableros-interactivos)
...
Luego filtramos y procesamos la informacion. Primero vamos a crear una tabla con el salario promedio general.
...
Luego creamos una nueva tabla desagregada por sexo
...
En el último comando creamos un archivo de excel con los datos procesados. Estos datos pueden ser importados en PowerBI, pero lo mejor en este caso será subir el script de R a PowerBI directamente. El archivo excel nos queda para revisar datos si es necesario.
...
Por ejemplo, para calcular el salario promedio ajustado por inflación con la serie de salrios construida más arriba, pododríamos deflactar el valor del salario por el IPC de esta manera: 
