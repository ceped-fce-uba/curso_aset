...
grViz("
digraph workflow {
  graph [rankdir=LR, fontname='Arial', bgcolor='transparent', pad='0.4']
  ...
  subgraph cluster_fuentes {
    ...
    github [label='GitHub\nScript R',       fillcolor='#24292e', fontcolor='white']
    excel  [label='Excel\nArchivo local',   fillcolor='#217346', fontcolor='white']
    sql    [label='Base SQL\nServidor',     fillcolor='#c0392b', fontcolor='white']
  }

  subgraph cluster_pbi {
    label='PowerBI Service'
    fontsize=13
    style='filled'
    fillcolor='#dce9f7'
    color='#2d6eb4'
    ...
    rs [label='Ejecuta\nscript R',             fillcolor='#2d6eb4', fontcolor='white']
    dg [label='Data Gateway\nconsulta Excel',  fillcolor='#2d6eb4', fontcolor='white']
    sq [label='Query SQL\ndirecta',            fillcolor='#2d6eb4', fontcolor='white']
  }

  tablero [label='Tablero PowerBI\nInteractivo', fillcolor='#f2c811', fontcolor='#333333', fontsize=13]

  github -> rs [label='descarga y ejecuta']
  excel  -> dg [label='conexion local']
  sql    -> sq [label='query directa']
  rs     -> tablero
  dg     -> tablero
  sq     -> tablero
}
